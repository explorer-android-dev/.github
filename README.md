...
| :--- | :--- | :--- |
| [**explorer-android-dev.github.io**](https://explorer-android-dev.github.io/) | ✅ **Рекомендуется** | Основной сайт. Обновления прилетают почти моментально через GitHub Pages. |
...
* 📂 Доработка файлового менеджера с интерфейсом **Fluent Design**.
* 🚀 Оптимизация сборки под **Windows Subsystem for Android (WSA)**.
* 🤖 Разработка Discord-бота **Githubber** (BDFD).
